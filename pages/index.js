...
const Home = () => {
  return (
    <div className="bg-nature bg-cover xl:bg-right xl:bg-no-repeat h-full">
      ...
      {/* text */}
      <div
        className="w-full min-h-full :pt-4 bg-gradient-to-r from-primary/10 via-black/30 to-black/10 
      flex items-center"
      >
        <div
          className="text-center h-full flex flex-col justfiy-center xl:pt-40 xl:text-left 
        container mx-auto"
        >
          {/* title */}
          <motion.h1
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        {/* bg */}
        <div
          className="bg-none xl:bg-explosion opacity-30 xl:bg-cover xl:bg-right xl:bg-no-repeat w-full 
